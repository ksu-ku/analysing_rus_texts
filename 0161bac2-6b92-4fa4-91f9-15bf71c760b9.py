...
texts = []
for filename in os.listdir("тексты/0161bac2-6b92-4fa4-91f9-15bf71c760b9"):
    with open(os.path.join("тексты/0161bac2-6b92-4fa4-91f9-15bf71c760b9", filename), 'r', encoding="UTF-8") as f:
        text = f.read()
        ...
        csv_file = 'analyse_0161bac2-6b92-4fa4-91f9-15bf71c760b9.csv'
        try:
