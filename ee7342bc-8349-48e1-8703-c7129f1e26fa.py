...
texts = []
for filename in os.listdir("тексты/ee7342bc-8349-48e1-8703-c7129f1e26fa"):
    with open(os.path.join("тексты/ee7342bc-8349-48e1-8703-c7129f1e26fa", filename), 'r', encoding="UTF-8") as f:
        text = f.read()
        ...
        csv_file = 'analyse_ee7342bc-8349-48e1-8703-c7129f1e26fa.csv'
        try:
