...
texts = []
for filename in os.listdir("тексты/5ba501ae-79d7-4317-b611-75d7fa3b451d"):
    with open(os.path.join("тексты/5ba501ae-79d7-4317-b611-75d7fa3b451d", filename), 'r', encoding="UTF-8") as f:
        text = f.read()
        ...
        csv_file = 'analyse_5ba501ae-79d7-4317-b611-75d7fa3b451d.csv'
        try:
