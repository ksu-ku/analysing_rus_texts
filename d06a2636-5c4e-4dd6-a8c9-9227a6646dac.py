...
texts = []
for filename in os.listdir("тексты/d06a2636-5c4e-4dd6-a8c9-9227a6646dac"):
    with open(os.path.join("тексты/d06a2636-5c4e-4dd6-a8c9-9227a6646dac", filename), 'r', encoding="UTF-8") as f:
        text = f.read()
        ...
        csv_file = 'analyse_d06a2636-5c4e-4dd6-a8c9-9227a6646dac.csv'
        try:
