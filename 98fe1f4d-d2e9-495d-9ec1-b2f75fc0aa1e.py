...
texts = []
for filename in os.listdir("тексты/98fe1f4d-d2e9-495d-9ec1-b2f75fc0aa1e"):
    with open(os.path.join("тексты/98fe1f4d-d2e9-495d-9ec1-b2f75fc0aa1e", filename), 'r', encoding="UTF-8") as f:
        text = f.read()
        ...
        csv_file = 'analyse_98fe1f4d-d2e9-495d-9ec1-b2f75fc0aa1e.csv'
        try:
