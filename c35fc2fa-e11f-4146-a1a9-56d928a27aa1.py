...
texts = []
for filename in os.listdir("тексты/c35fc2fa-e11f-4146-a1a9-56d928a27aa1"):
    with open(os.path.join("тексты/c35fc2fa-e11f-4146-a1a9-56d928a27aa1", filename), 'r', encoding="UTF-8") as f:
        text = f.read()
        ...
        csv_file = 'analyse_c35fc2fa-e11f-4146-a1a9-56d928a27aa1.csv'
        try:
