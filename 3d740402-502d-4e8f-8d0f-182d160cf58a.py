...
texts = []
for filename in os.listdir("тексты/3d740402-502d-4e8f-8d0f-182d160cf58a"):
    with open(os.path.join("тексты/3d740402-502d-4e8f-8d0f-182d160cf58a", filename), 'r', encoding="UTF-8") as f:
        text = f.read()
        ...
        csv_file = 'analyse_3d740402-502d-4e8f-8d0f-182d160cf58a.csv'
        try:
