...
texts = []
for filename in os.listdir("тексты/191e37ff-10d8-4a4b-bab4-644f01595213"):
    with open(os.path.join("тексты/191e37ff-10d8-4a4b-bab4-644f01595213", filename), 'r', encoding="UTF-8") as f:
        text = f.read()
        ...
        csv_file = 'analyse_191e37ff-10d8-4a4b-bab4-644f01595213.csv'
        try:
