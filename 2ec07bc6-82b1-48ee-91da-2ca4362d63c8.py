...
texts = []
for filename in os.listdir("тексты/2ec07bc6-82b1-48ee-91da-2ca4362d63c8"):
    with open(os.path.join("тексты/2ec07bc6-82b1-48ee-91da-2ca4362d63c8", filename), 'r', encoding="UTF-8") as f:
        text = f.read()
        ...
        csv_file = 'analyse_2ec07bc6-82b1-48ee-91da-2ca4362d63c8.csv'
        try:
